...
describe "#multiply" do
  describe "multiplies two numbers" do
    it "returns 0 when one of the numbers is zero" do
      expect(multiply(89, 0)).to eq(0)
    end

    it "multiplies 4 and 7" do
      expect(multiply(4, 7)).to eq(28)
    end
  end

  it "multiplies several numbers" do
    expect(multiply(2, 5, 8, 9, 10)).to eq(7200)
  end
end
...
describe "#power" do
  ...
  it "returns 0 when Zero is raised to any power" do
    expect(power(0, 8)).to eq(0)
  end

  it "returns 1 when any number is raised to power Zerro}" do
